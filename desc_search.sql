SELECT DISTINCT
                ...
                child_special_to.value AS Child_Special_To_Date,
                    descr.value AS Child_Description 
                FROM catalog_product_link l
                    JOIN catalog_product_entity child ON child.entity_id = l.linked_product_id
                ...
                JOIN catalog_product_entity_text descr
                    ...
                    AND LOWER(descr.value) LIKE CONCAT('%', LOWER('oliva'), '%')
                        ORDER BY parent.sku
                        LIMIT 100
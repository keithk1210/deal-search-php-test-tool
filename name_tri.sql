SELECT DISTINCT
                ...
                FROM catalog_product_link l
                    JOIN (
                    SELECT c.* , ((LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'Art', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'rtu', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'tur', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'uro', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'ro ', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'o F', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), ' Fu', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'Fue', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'uen', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'ent', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'nte', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'te ', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'e D', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), ' Do', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'Dou', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'oub', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'ubl', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'ble', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'le ', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'e C', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), ' Ch', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'Cha', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'hat', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'ate', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'tea', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'eau', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'au ', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'u M', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), ' MA', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'MAD', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'AD ', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), 'D 5', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), ' 5p', ''))) / 3 + (LENGTH(LOWER(c.name)) - LENGTH(REPLACE(LOWER(c.name), '5pk', ''))) / 3) AS match_score
                    FROM (
